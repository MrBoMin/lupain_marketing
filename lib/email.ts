  ...
  return {
    ...
    html: `
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #fffbf5; margin: 0; padding: 40px 20px;">
          <div style="max-width: 500px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
            ...
            <div style="background: ${BRAND_COLOR}; padding: 32px; text-align: center;">
              <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: 600;">${BRAND_NAME}</h1>
            </div>
            
            <div style="padding: 40px 32px;">
              <div style="text-align: center; margin-bottom: 32px;">
                <div style="font-size: 48px; margin-bottom: 16px;">🎉</div>
                <h2 style="color: #111827; margin: 0 0 8px 0; font-size: 22px;">Enrollment Approved!</h2>
                <p style="color: #6b7280; margin: 0; font-size: 15px;">Welcome aboard, ${studentName}!</p>
              </div>
              
              <div style="background: #fff7ed; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
                <p style="color: #9a3412; margin: 0 0 4px 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px;">Course</p>
                <p style="color: #111827; margin: 0; font-size: 18px; font-weight: 600;">${courseName}</p>
              </div>
              ...
              <div style="text-align: center;">
                <a href="${SITE_URL}/dashboard" style="display: inline-block; background: ${BRAND_COLOR}; color: #ffffff; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px;">
                  Go to Dashboard →
                </a>
              </div>
            </div>
            
            <div style="background: #fffbf5; padding: 24px 32px; text-align: center; border-top: 1px solid #fed7aa;">
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #fffbf5; margin: 0; padding: 40px 20px;">
          <div style="max-width: 500px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
            ...
            <div style="padding: 40px 32px;">
              <div style="text-align: center; margin-bottom: 32px;">
                <h2 style="color: #111827; margin: 0 0 8px 0; font-size: 22px;">Enrollment Update</h2>
                <p style="color: #6b7280; margin: 0; font-size: 15px;">Hi ${studentName},</p>
              </div>
              ...
              <div style="text-align: center;">
                <a href="${SITE_URL}" style="display: inline-block; background: ${BRAND_COLOR}; color: #ffffff; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px;">
                  Visit ${BRAND_NAME}
                </a>
              </div>
            </div>
